        ...
        <Container fluid className='g-5' >
          <Row>
            ...
            <Col lg={3} md={12} xs={12}>
              ...
              <Cards img={CardData[1].img} title={CardData[0].title} text={CardData[0].text} btn={CardData[0].btn} onClick={() => goToDaily()} />
              <Cards img={CardData[1].img} title={CardData[1].title} text={CardData[1].text} btn={CardData[1].btn} onClick={() => goToDaily()}/>
            </Col>
          </Row>
        </Container>
      </section>
